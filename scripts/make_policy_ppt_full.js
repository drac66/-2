...
for (const s of slides) {
  ...
  slide.addText(s.title, {
    ...
    fontFace: 'Microsoft YaHei', fontSize: 28, bold: true, color: '1F4E79'
  });
  ...
  slide.addText(s.body, {
    x: 0.8, y: 1.45, w: 11.9, h: 5.9,
    fontFace: 'Microsoft YaHei', fontSize: 20, color: '222222',
    valign: 'top', breakLine: true, margin: 0.06,
    paraSpaceAfterPt: 8
  });

  slide.addText('动画统一：本页所有文本框按顺序设置“飞入（自底部）”，持续0.5秒，延迟每项+0.1秒', {
    x: 0.6, y: 7.02, w: 12.1, h: 0.2,
    fontFace: 'Microsoft YaHei', fontSize: 10, color: '666666', align: 'right'
  });
}

pptx.writeFile({ fileName: 'C:\\Users\\damaster\\.openclaw\\workspace\\形式与政策_讨论课_讲稿同款_完整版.pptx' });
